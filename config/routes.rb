...
Kassi::Application.routes.draw do
  ...
  scope "(/:locale)", :constraints => { :locale => locale_matcher } do
    ...
    get 'getotherpartyonlinestatus' => "homepage#getotherpartyonlinestatus", as: :getotherpartyonlinestatus
    resources :listings do
      get "/offers" => "listings#show_offers", as: :offers
      member do
        post :follow
        delete :unfollow
      end
    ...
    devise_scope :person do
      ...
      get "/account_setup" => "account_setup#index", as: :account_setup

      # Business account setup
      get "/businesses/account_setup/step1" => "account_setup/businesses#new_step1", as: :business_account_setup_step1
      get "/businesses/account_setup/step2" => "account_setup/businesses#new_step2", as: :business_account_setup_step2
      get "/businesses/account_setup/step3" => "account_setup/businesses#new_step3", as: :business_account_setup_step3
      get "/businesses/account_setup/step4" => "account_setup/businesses#new_step4", as: :business_account_setup_step4
      get "/businesses/account_setup/step5" => "account_setup/businesses#new_step5", as: :business_account_setup_step5
      get "/businesses/account_setup/step6" => "account_setup/businesses#new_step6", as: :business_account_setup_step6

      put "/businesses/account_setup/step1" => "account_setup/businesses#new_step1", as: :business_account_setup_step1_submit
      put "/businesses/account_setup/step2" => "account_setup/businesses#new_step2", as: :business_account_setup_step2_submit
      put "/businesses/account_setup/step3" => "account_setup/businesses#new_step3", as: :business_account_setup_step3_submit
      put "/businesses/account_setup/step4" => "account_setup/businesses#new_step4", as: :business_account_setup_step4_submit
      put "/businesses/account_setup/step5" => "account_setup/businesses#new_step5", as: :business_account_setup_step5_submit
      put "/businesses/account_setup/step6" => "account_setup/businesses#new_step6", as: :business_account_setup_step6_submit

      # Worker account setup
      get "/workers/account_setup/step1" => "account_setup/workers#new_step1", as: :worker_account_setup_step1
      get "/workers/account_setup/step2" => "account_setup/workers#new_step2", as: :worker_account_setup_step2
      get "/workers/account_setup/step3" => "account_setup/workers#new_step3", as: :worker_account_setup_step3
      get "/workers/account_setup/step4" => "account_setup/workers#new_step4", as: :worker_account_setup_step4
      get "/workers/account_setup/step5" => "account_setup/workers#new_step5", as: :worker_account_setup_step5
      get "/workers/account_setup/step6" => "account_setup/workers#new_step6", as: :worker_account_setup_step6

      put "/workers/account_setup/step1" => "account_setup/workers#new_step1", as: :worker_account_setup_step1_submit
      put "/workers/account_setup/step2" => "account_setup/workers#new_step2", as: :worker_account_setup_step2_submit
      put "/workers/account_setup/step3" => "account_setup/workers#new_step3", as: :worker_account_setup_step3_submit
      put "/workers/account_setup/step4" => "account_setup/workers#new_step4", as: :worker_account_setup_step4_submit
      put "/workers/account_setup/step5" => "account_setup/workers#new_step5", as: :worker_account_setup_step5_submit
      put "/workers/account_setup/step6" => "account_setup/workers#new_step6", as: :worker_account_setup_step6_submit

      # Buyer account setup
      get "/buyers/account_setup/step1" => "account_setup/buyers#new_step1", as: :buyer_account_setup_step1
      get "/buyers/account_setup/step2" => "account_setup/buyers#new_step2", as: :buyer_account_setup_step2
      get "/buyers/account_setup/step3" => "account_setup/buyers#new_step3", as: :buyer_account_setup_step3
      get "/buyers/account_setup/step4" => "account_setup/buyers#new_step4", as: :buyer_account_setup_step4
      get "/buyers/account_setup/step5" => "account_setup/buyers#new_step5", as: :buyer_account_setup_step5
      get "/buyers/account_setup/step6" => "account_setup/buyers#new_step6", as: :buyer_account_setup_step6

      put "/buyers/account_setup/step1" => "account_setup/buyers#new_step1", as: :buyer_account_setup_step1_submit
      put "/buyers/account_setup/step2" => "account_setup/buyers#new_step2", as: :buyer_account_setup_step2_submit
      put "/buyers/account_setup/step3" => "account_setup/buyers#new_step3", as: :buyer_account_setup_step3_submit
      put "/buyers/account_setup/step4" => "account_setup/buyers#new_step4", as: :buyer_account_setup_step4_submit
      put "/buyers/account_setup/step5" => "account_setup/buyers#new_step5", as: :buyer_account_setup_step5_submit
      put "/buyers/account_setup/step6" => "account_setup/buyers#new_step6", as: :buyer_account_setup_step6_submit

      resource :offers, only: [:create] do
        get "accept/:id" => "offers#accept", as: :offers_accept
      end

      # conversation routes #
      resources :conversations, :only => [:index, :show] do
        collection do
          get 'listings/:listing_id' => 'conversations#listings', :as => :listing_conversation
          get 'read', to: "messages#read", as: :fetch_messages
        end
      end

      # status routes #
      namespace :person_online_status do
        post 'set_static'
      end
      # Categories controller for JSON ajax fetch
      get "/categories(/:id)" => "categories#index", constraints: { format: /(js|json)/ }, as: :categories_list
      ...
      resources :people, except: [:show], :path => "" do
        ...
        # Card Poster Edit
        get 'card_poster_edit', to: 'card_poster#show'
