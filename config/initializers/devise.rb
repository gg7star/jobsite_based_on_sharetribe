...
Devise.setup do |config|
  ...
  # https://deepakrip007.wordpress.com/2013/11/01/twitter-and-linkedin-integration-using-devise-and-omniauth-in-rails-app/
  ...
  config.omniauth :facebook,
                  ...
                  callback_url:"#{Rails.env.production? ? "http://jobcie.degries.com" : "http://jobcie.localhost:3000"}/people/auth/facebook/callback"

  config.omniauth :linkedin, '78drrxfrmlcpv0', 'x3Dt2ETctcvStiwr',
                  callback_url:"#{Rails.env.production? ? "http://jobcie.degries.com" : "http://jobcie.localhost:3000"}/people/auth/linkedin/callback"
  ...
  # end
  config.secret_key = '398f89427466fdeb31521d97a25f5a66f881dfc51db12f9926eb6a343485a14a6b0cd15743f79c21135c135b456fe1315bfa45ed122c6557d8c3e174d980b442'
end
