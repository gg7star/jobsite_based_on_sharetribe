...
class HomepageController < ApplicationController
  ...
  def index
    ...
    # set dashboard mode
    session[:dashboard_mode] = params[:dashboard_mode] || (buyer? ? :client : :worker)
  ...
  # Add by joelle 
  # Get online client modal dialog content
  def getotherpartyonlinestatus
    respond_to do |format|
      format.js { render :layout => false, locals: { statuslist: MarketplaceService::OnlineStatus.new(@current_user).getStatusList } }
    end
  end
