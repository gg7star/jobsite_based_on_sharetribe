...
class ListingsController < ApplicationController
  ...
  before_filter :only => [ :edit, :edit_form_content, :update, :close, :follow, :unfollow, :show_offers ] do |controller|
    controller.ensure_logged_in t("layouts.notifications.you_must_log_in_to_view_this_content")
  end

  before_filter :only => [ :new, :new_form_content, :create, :index ] do |controller|
  ...
  before_filter :ensure_is_worker_or_buyer, only: [:index]
