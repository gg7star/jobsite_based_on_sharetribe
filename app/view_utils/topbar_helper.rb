  ...
  def topbar_props(community:, path_after_locale_change:, user: nil, search_placeholder: nil,
...

    {
      logo: {
        ...
        image: ActionController::Base.helpers.asset_url('assets/landing_page/logo.png'),#community.wide_logo.present? ? community.stable_image_url(:wide_logo, :header) : nil,
        image_highres: ActionController::Base.helpers.asset_url('assets/landing_page/logo.png') #community.wide_logo.present? ? community.stable_image_url(:wide_logo, :header_highres) : nil
      },
      search: true ? nil : {
      ...
      newListingButton: user.present? ? nil : {
      ...
      marketplace: {
        marketplace_color1: "#fff",#CommonStylesHelper.marketplace_colors(community)[:marketplace_color1],
