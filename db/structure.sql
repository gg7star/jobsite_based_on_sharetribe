...
--
-- Host: localhost    Database: jobcie_development
-- ------------------------------------------------------
...
--
-- Table structure for table `categories_people`
--
...
CREATE TABLE `listings` (
  ...
  `availability` varchar(32) DEFAULT 'none',
  `setup_step` int(11) DEFAULT '1',
  `valid_until_turnaround` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `locations` (
  ...
  `distance_limit_unit` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `people` (
  ...
  `overall_name` varchar(255) DEFAULT NULL,
  `account_setup_step` int(11) DEFAULT '1',
  `fixed_online_status` varchar(255) DEFAULT NULL,
  ...
  UNIQUE KEY `index_people_on_linkedin_id` (`linkedin_id`),
...
-- Dump completed on 2017-03-24 23:37:30
...
INSERT INTO schema_migrations (version) VALUES ('20170222170044');

INSERT INTO schema_migrations (version) VALUES ('20170223135602');

INSERT INTO schema_migrations (version) VALUES ('20170223155144');

INSERT INTO schema_migrations (version) VALUES ('20170223171414');

INSERT INTO schema_migrations (version) VALUES ('20170224120959');

INSERT INTO schema_migrations (version) VALUES ('20170224124042');

INSERT INTO schema_migrations (version) VALUES ('20170224171313');

INSERT INTO schema_migrations (version) VALUES ('20170224190907');

INSERT INTO schema_migrations (version) VALUES ('20170224200313');

INSERT INTO schema_migrations (version) VALUES ('20170225163536');

INSERT INTO schema_migrations (version) VALUES ('20170225164241');

INSERT INTO schema_migrations (version) VALUES ('20170228153536');

INSERT INTO schema_migrations (version) VALUES ('20170302162714');

INSERT INTO schema_migrations (version) VALUES ('20170303103512');

INSERT INTO schema_migrations (version) VALUES ('20170307183657');

INSERT INTO schema_migrations (version) VALUES ('20170314005110');

INSERT INTO schema_migrations (version) VALUES ('20170317002840');

INSERT INTO schema_migrations (version) VALUES ('20170319015239');
